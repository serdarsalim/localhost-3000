...
VERSION=$(TZ=Asia/Kuala_Lumpur date +%Y.%m.%d)
BUILD=$(TZ=Asia/Kuala_Lumpur date +%Y%m%d%H%M%S)
VERSION_DISPLAY=$(TZ=Asia/Kuala_Lumpur date +"%Y-%m-%d %H:%M MYT")

# Inject version into Swift so the UI can display it.
cat > "Sources/LocalhostApp/AppVersion.swift" << SWIFTEOF
// Auto-generated by build-app.sh — do not edit.
let appVersion = "$VERSION_DISPLAY"
SWIFTEOF
